    ...
    <header class="p-3 bg-dark text-white">
      ...
      <main class="col-md-10 ms-sm-auto col-lg-10 px-md-10">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">List of Customer</h1>
            </div>
...
while($row = oci_fetch_array($stid)){
                  ...
                  echo"<td><a href='CustomerView.php?id=". $row['CUST_ID'] ."' class='btn btn-primary btn-lg active' role='button btn-sm' aria-pressed='true'>View</a></td>";
      ...
      <?php
        ...
        $sql = "SELECT COUNT(CUST_ID)AS COUNT FROM CUSTOMERS";
      ...
      <div class="card" style="width: 18rem; ">
        ...
        <div class="card-body">
          <p class="card-text"><h3>Total Customer Registered</h3><?php echo $count." persons";?></p>
        </div>
      </div>
      </div>
      <div class="container">
