...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "UPDATE CUSTOMERS SET CUST_NAME ='$custname', CUST_PHONE = '$custphone', ADDRESS ='$address', EMAIL ='$email', ATTACHMENT = '$final_file' WHERE CUST_ID ='$id'  ";
    $stid = oci_parse($conn,$sql);
    if(oci_execute($stid)){
    ...
    <header class="p-3 bg-dark text-white">
      ...
      <main class="col-md-10 ms-sm-auto col-lg-10 px-md-10">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Customer Update</h1>
          </div>
                ...
                <form method="POST" data-validate="parsley" enctype="multipart/form-data">
                    <div class="mb-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="custname" value="<?php echo $custname?>">
                          </div>
                       <label for="phone" class="form-label">Phone Number</label>
                      <input type="text" class="form-control" name="custphone" value="<?php echo $custphone?>" >
                    ...
                    <div class="mb-3 form-check">
                      ...
                      <label class="form-check-label" for="exampleCheck1">Keep customer confidential</label>
                    </div>
