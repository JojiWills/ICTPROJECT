...
include('../config.php');
  ...
  $sql = "SELECT * FROM CUSTOMERS WHERE CUST_ID = '$lastcust'";
  $stid = oci_parse($conn,$sql);
  $result = oci_execute($stid);
  $row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS);
  $lastcustname = $row["CUST_NAME"];
...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO CUSTOMERS (CUST_ID,CUST_NAME,CUST_PHONE,ADDRESS,EMAIL,ATTACHMENT) VALUES ('$newcust','$custname','$custphone','$address','$email','$final_file')";
    $stid = oci_parse($conn,$sql);
    if(oci_execute($stid)){
    ...
    <header class="p-3 bg-dark text-white">
      ...
      <main class="col-md-10 ms-sm-auto col-lg-10 px-md-10">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Customer Create</h1>
          </div>
            ...
            <div class="row">
              <div class="col-8">
                <form method="POST" data-validate="parsley" enctype="multipart/form-data">
                    <div class="mb-3">
                        <div class="mb-3">
                         <label for="name" class="form-label">ID : <?php echo $newcust; ?></label><br>
